...
const readTemplate = async (inputTemplateFile) => {
    ...
    return await fs.promises.readFile(inputTemplateFile, { encoding: 'utf8' });
}
...
const validateTerminologyStructure = async (terminologyStructure) => {
    ...
    const fhirSchema = await fs.promises.readFile('./schemas/R5/fhir.schema.json', { encoding: 'utf8' });
